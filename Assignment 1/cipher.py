...
if cipher == "shift" and kind == "encrypt":
    text = textfile
    s = int(sys.argv[5])
    #print ("Text  : " + text)
    #print ("Shift : " + str(s))
...
if cipher == "affine" and kind == "encrypt":
    text = textfile
...
if cipher == "affine" and kind == "decrypt":
    text = textfile
    key = [int(sys.argv[5]),int(sys.argv[6])]
...
if cipher == "vigenere" and kind == "encrypt":
    string = textfile
    keyword = sys.argv[5]
...
if cipher == "vigenere" and kind == "decrypt":
    string = textfile
    keyword = sys.argv[5]
    key = generateKey(string, keyword)
